...
void kernel_main(void) {
    ...
    printf("Hopefully you didn't install this on your computer, for two reasons: 1, you can't do anything, and 2, you can go to a browser window and check out the code!\n");
};
